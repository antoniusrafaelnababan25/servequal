...
class KuesionerMahasiswaController extends Controller
{
    ...
    {
        // Hapus session jika perlu (opsional)
        // Session::forget(['mahasiswa_id', 'mahasiswa_nama', 'mahasiswa_nim', 'kelas', 'jurusan', 'prodi_id', 'periode_id', 'periode_nama', 'periode_tanggal', 'periode_target']);
