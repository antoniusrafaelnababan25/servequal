...
@section('title', 'Dashboard Admin - SERVQUAL POLMED')
    ...
    <div class="container-fluid px-0">
        ...
        <div class="bg-white rounded-4 shadow-sm p-3 mb-4">
            <div class="row align-items-center">
                ...
                <div class="col-md-6">
                    <form method="GET" action="{{ route('admin.dashboard') }}" id="periodeForm">
                ...
                <div class="card-hover bg-white rounded-4 shadow-sm p-3 h-100 border-0"
                    ...
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <h3 class="mb-0 fw-bold text-success display-6">{{ number_format($totalDosen) }}</h3>
                        </div>
                ...
                <div class="card-hover bg-white rounded-4 shadow-sm p-3 h-100 border-0"
                    ...
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <h3 class="mb-0 fw-bold text-info display-6">{{ number_format($totalMahasiswa) }}</h3>
                        </div>
        ...
        <!-- Daftar User (Dosen & Mahasiswa) dengan Filter -->
        <div class="bg-white rounded-4 shadow-sm p-4">
            <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-4">
                <h5 class="fw-semibold mb-0"><i class="bi bi-people-fill me-2 text-purple-600"></i>Daftar Pengguna
                    (Dosen/Mahasiswa)</h5>
                <form method="GET" action="{{ route('admin.dashboard') }}" id="filterForm"
                    ...
                    <div class="input-group input-group-sm" style="width: 260px;">
                        <input type="text" name="search" class="form-control bg-light border-0 rounded-start-pill"
                            placeholder="Cari nama / nim / nidn" value="{{ request('search') }}">
                    ...
                    <tbody>
                        @forelse($users as $user)
                            <tr>
                                ...
                                <td>{{ $user->email }}</td>
                                <td><span
                                        class="badge bg-purple-100 text-purple-800 rounded-pill px-3 py-1">{{ ucfirst($user->role) }}</span>
                                </td>
